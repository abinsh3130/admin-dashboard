...
import { FaSearch, FaFilter, FaEye, FaTrash, FaSortUp, FaSortDown, FaFileExcel, FaFilePdf } from "react-icons/fa";
...
const Products = () => {
    ...
    const handleExportPDF = () => {
        ...
        exportToPDF(exportData, `products_${new Date().toISOString().split('T')[0]}`, 'Products Report');
    };
